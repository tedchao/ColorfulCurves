...
:star: News :star: (11.13.2023): The GUI now supports zoom in/out. To do this, toggle the switch to ON in the zoom in/out box and click on random pixel. Then, use the slider to control the magnitude of the scale. Toggling the switch to OFF allows you to add image constraints by clicking on pixels again.
